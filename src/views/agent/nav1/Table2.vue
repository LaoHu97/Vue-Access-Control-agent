  ...
  <el-form :inline="true" :model="filters" ref="filters" size="medium">
    <el-row>
      ...
      <el-form-item prop="state2">
          <el-select v-model="filters.state2" placeholder="请选择业务员" :multiple="false" filterable remote :remote-method="remoteSale" :loading="loading" clearable @visible-change="clickSale">
